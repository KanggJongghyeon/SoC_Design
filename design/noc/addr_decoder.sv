...
module addr_decoder #(
    ...
    wire    w_axi2apb_en1, w_axi2apb_en2;
    ...
    assign w_axi2apb_en1    = ((AXVALID == 1'b1) && (AXADDR >= `MMIO_TIMER)     && (AXADDR < `MMIO_I2C))        ? 1'b1 : 1'b0;
    assign w_axi2apb_en2    = ((AXVALID == 1'b1) && (AXADDR >= `MMIO_GPIO)      && (AXADDR < `MMIO_CACHE_MEM))  ? 1'b1 : 1'b0;
    assign o_axi2apb_en     = w_axi2apb_en1 | w_axi2apb_en2; 
    ...
    assign o_aux_mem_en     = ((AXVALID == 1'b1) && (AXADDR >= `MMIO_AUX_MEM))                                  ? 1'b1 : 1'b0;
